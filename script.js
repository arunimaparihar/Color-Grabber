...
const colorPickerBtn = document.querySelector("#colour-picker");
const clearAll = document.querySelector(".clearall");
const colorList = document.querySelector(".all-colour");
const pickedColors = JSON.parse(localStorage.getItem("picked-colour") || "[]");
...
const showColor = () => {
    ...
    document.querySelector(".picked-colour").classList.remove("hide");
    // Add a click event listener to each color element to copy the color code
    document.querySelectorAll(".colour").forEach(li => {
...
const clearAllColors = () => {
    ...
    localStorage.setItem("picked-colors", JSON.stringify(pickedColors));
    document.querySelector(".picked-colour").classList.add("hide");
}
